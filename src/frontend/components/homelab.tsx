...
const ComputerExtras = () => {
    ...
    const [lightCount, setLightCount] = React.useState(Math.trunc(Math.random() * 3) + 1);
                ...
                <div className={`${classes.content} ${condense ? classes.noParallax : classes.parallax}`} style={{ backgroundPositionY: -scrollY * 0.25 }}>
                    <div className={condense ? classes.innerContent : classes.computerBorder} style={{ width: condense ? "100%" : "80%", marginTop: condense ? "0" : "5rem" }}>
                        <div className={condense ? classes.innerContent : classes.computerCell} style={{ marginTop: condense ? "65px" : "0" }}>
                            <Typography variant="h3" style={{ color: condense ? theme.PALETTE_BLACK : theme.PALETTE_WHITE }}>Introduction</Typography>
                        ...
                        <div className={condense ? classes.starSection : classes.computerCell}>
                            <Typography variant="h3" style={{ color: theme.PALETTE_WHITE }}>The Base Layer</Typography>
                        ...
                        <div className={condense ? classes.innerContent : classes.computerCell}>
                            <Typography variant="h3" style={{ color: condense ? theme.PALETTE_BLACK : theme.PALETTE_WHITE }}>Node Network</Typography>
                            <CircleLine circleCount={10} />
                            <Typography variant="body1" style={{ color: condense ? theme.PALETTE_LIGHT_BLACK : theme.PALETTE_DARK_WHITE }} className={classes.bodyText}>
                        ...
                        <div className={condense ? classes.starSection : classes.computerCell}>
                            <Typography variant="h3" style={{ color: theme.PALETTE_WHITE }}>Cattle System</Typography>
                            <CircleLine circleCount={10} />
                            <Typography variant="body1" style={{ color: theme.PALETTE_DARK_WHITE }} className={classes.bodyText}>
                        ...
                        <div className={condense ? classes.innerContent : classes.computerCell}>
                            <Typography variant="h3" style={{ color: condense ? theme.PALETTE_BLACK : theme.PALETTE_WHITE }}>Traffic Routing</Typography>
                        ...
                        <div className={condense ? classes.starSection : classes.computerCell}>
                            <Typography variant="h3" style={{ color: theme.PALETTE_WHITE }}>Minecraft Server</Typography>
                        ...
                        <div className={condense ? classes.innerContent : classes.computerCell}>
                            <Typography variant="h3" style={{ color: condense ? theme.PALETTE_BLACK : theme.PALETTE_WHITE }}>Epilogue</Typography>
