            ...
            <Box>
                ...
                {expanded &&
                    ...
                    >
                        ...
                        <Typography variant="h3" color="text.primaryDark" sx={{ marginTop: "60px" }}>Skills</Typography>
                        <CircleLine count={5} />
                        <Typography variant="h5" color="text.secondaryDark" sx={{ marginBottom: "40px" }}>Confidence</Typography>
                        <Grid container spacing={{ xs: 2, sm: 3, md: 4 }} columnSpacing={6} columns={12} sx={{ padding: { xs: "0 30px", md: "0 60px" }, maxWidth: "1400px" }}>
                            <SkillBar percentage={90} yearCount={4} skillName="ReactJS" iconPath="/images/react.png" iconAlt="React Logo" /> {/* 2019 */}
                            <SkillBar percentage={90} yearCount={8} skillName="HTML/CSS" iconPath="/images/csshtml.svg" iconAlt="HTML/CSS Logo" /> {/* 2015 */}
                            <SkillBar percentage={90} yearCount={7} skillName="JS/TS" iconPath="/images/typescript.png" iconAlt="JS/TS Logo" /> {/* 2016 */}
                            <SkillBar percentage={90} yearCount={6} skillName="C++" iconPath="/images/cpp.svg" iconAlt="C++ Logo" /> {/* 2017 */}
                            <SkillBar percentage={80} yearCount={5} skillName="C#/DotNet" iconPath="/images/cs.svg" iconAlt="C#/DotNet Logo" /> {/* 2018 */}
                            <SkillBar percentage={80} yearCount={4} skillName="SQL" iconPath="/images/sql.png" iconAlt="SQL Logo" /> {/* 2019 */}
                            <SkillBar percentage={70} yearCount={3} skillName="Python" iconPath="/images/python.png" iconAlt="Python Logo" /> {/* 2020 */}
                            <SkillBar percentage={50} yearCount={3} skillName="Azure" iconPath="/images/azure.png" iconAlt="Azure Logo" /> {/* 2020 */}
                        </Grid>
